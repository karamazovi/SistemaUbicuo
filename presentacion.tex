...
\begin{frame}{Ejecuci\'on del Sistema}

El sistema requiere \textbf{3 terminales} (m\'as una opcional para Streamlit):

\vspace{0.5em}
\begin{block}{Terminal 1 --- Nodo Sensor 1}
\texttt{cd "...SistemaUbicuo" \&\& python nodo\_sensor\_1.py}
\end{block}

\begin{block}{Terminal 2 --- Nodo Sensor 2}
\texttt{cd "...SistemaUbicuo" \&\& python nodo\_sensor\_2.py}
\end{block}

\begin{block}{Terminal 3 --- Nodo Central}
\texttt{cd "...SistemaUbicuo" \&\& python nodo\_central.py}
\end{block}

\begin{exampleblock}{Terminal 4 --- Interfaz Streamlit (opcional)}
\texttt{cd "...SistemaUbicuo" \&\& streamlit run interfaz.py}
\end{exampleblock}
\end{frame}
